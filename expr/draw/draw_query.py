...
def draw_range_contains_query(prefix, ):
    ...
    fig.savefig("fig8.pdf", format='pdf', bbox_inches='tight')
    # plt.show()
...
def draw_range_query_intersects(prefix,
    ...
    fig.savefig('fig9.pdf', format='pdf', bbox_inches='tight')
    # plt.show()
...
def draw_vary_rays(prefix):
    ...
    fig.subplots_adjust(wspace=-0.25)  # Adjust the width space between axes
    ...
    fig.savefig("fig10.pdf", format='pdf', bbox_inches='tight')
    # plt.show()
